...
include { computing_Seq-ML_trees_no_bs } from '../modules/computing_seq-ml_trees.nf'
...
workflow GENERATE_SEQ_ML_NO_BS_TREES{
    ...
    main:
    converting_to_phylip(fasta_aln)
    computing_Seq-ML_trees_no_bs(converting_to_phylip.out)
    
    emit:
    computing_Seq-ML_trees_no_bs.out
}
